...
const Hero = () => {
    ...
    useGSAP(() => {
        if (hasClicked) {
            ...
            gsap.from("#current-video", {
                transformOrigin: "center center", scale: 0, duration: 1.5, ease: "power1.inOut",
            });
        }
    }, {
    ...
    return (<section className="relative h-dvh w-screen overflow-x-hidden">
        ...
        <h1 className="special-font hero-heading absolute bottom-5 right-6 text-black">G<b>a</b>ming</h1>
    </section>)
}
